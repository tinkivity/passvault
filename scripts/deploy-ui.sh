...
case "$ENV" in
  dev)
    VITE_PASSKEY_REQUIRED=""      # omitted for dev (feature flag off)
    ;;
  beta)
...

{
  ...
  echo "VITE_VIEW_TIMEOUT_SECONDS=300"
  echo "VITE_EDIT_TIMEOUT_SECONDS=600"
  echo "VITE_ADMIN_TIMEOUT_SECONDS=86400"
} > "$ENV_FILE"
