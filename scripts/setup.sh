#!/usr/bin/env bash
# setup.sh — Build and deploy the PassVault frontend (or start a local dev server).
#
# Usage:
#   ./scripts/setup.sh --env <dev|beta|prod> [--profile <aws-profile>] [--region <region>] [--stack <stack-name>]
#
# Environments:
...
{
  echo "# Auto-generated by scripts/setup.sh (--env $ENV) — DO NOT COMMIT (covered by .gitignore)"
